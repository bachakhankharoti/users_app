...
class _MainScreenState extends State<MainScreen> {
  ...
  saveRideRequestInformation() {
    ...
    referenceRideRequest =
        FirebaseDatabase.instance.ref().child("All Orders Requests").push();
    ...
    tripRideRequestInfoStreamSubscription =
      ...
      if ((eventSnap.snapshot.value as Map)["Vehicle Details"] != null) {
        setState(() {
          driverCarDetails =
              (eventSnap.snapshot.value as Map)["Vehicle Details"].toString();
        });
      }
    ...
    if (response == "driverChosen") {
      FirebaseDatabase.instance
        ...
        if (snap.snapshot.value != null) {
          ...
          Fluttertoast.showToast(msg: "This Bike do not exist. Try again.");
        }
      });
    }
  }
  ...
  sendNotificationToDriverNow(String chosenDriverId) {
    ...
    FirebaseDatabase.instance
      ...
      if (snap.snapshot.value != null) {
        ...
        Fluttertoast.showToast(msg: "Please choose another Bike.");
        return;
      }
    });
  }
...
*/
                      ...
                      AnimatedButton(
                        ...
                        onPressed: () {
                          print(onlineNearByAvailableDriversList);
                          ...
                          if (Provider.of<AppInfo>(context, listen: false)
                            ...
                            Fluttertoast.showToast(
                                msg: "your current address is missing");
                          }
                        },
                      ),
  ...
  createActiveNearByDriverIconMarker() {
    if (activeNearbyIcon == null) {
      ...
      BitmapDescriptor.fromAssetImage(imageConfiguration, "images/bike.png")
          .then((value) {
